...
export default function About() {
  ...
  return (
    ...
    <section
      id="about"
      className="py-24 bg-transparent text-white overflow-hidden relative"
    >
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative w-64 h-80 md:w-80 md:h-[450px] bg-transparent rounded-2xl overflow-hidden">
              <img
                src={MyPhoto}
                alt="About Moiz"
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="text-2xl text-indigo-500 mb-2 flex justify-center">
                    {stat.icon}
                  </div>
                  <h5 className="text-[10px] md:text-xs font-semibold text-gray-400 uppercase tracking-tight">
                    {stat.label}
                  </h5>
            ...
            <div className="space-y-4 text-gray-400 leading-relaxed">
              <p>
                Hello! I'm{" "}
                <span className="text-white font-semibold">Moiz Ahmed</span>, a
